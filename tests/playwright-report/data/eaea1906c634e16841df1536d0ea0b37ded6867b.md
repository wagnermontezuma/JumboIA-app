...
- Name: Chat - JumboIA >> CHAT-005: Tratamento de erro da API OpenRouter (manual)
- Location: C:\Users\monte\Desktop\Projetos\JumboIA\tests\specs\chat.spec.ts:71:7
...
Call log:
  - waiting for getByRole('button', { name: /enviar/i })
    ...
    at C:\Users\monte\Desktop\Projetos\JumboIA\tests\specs\chat.spec.ts:78:22
```
...
- main:
  ...
  - textbox "Digite sua pergunta aqui...": Teste de erro de API
  - text: 20/5000
  - button "JumboIA"
