...
- Name: Chat - JumboIA >> CHAT-007: Interação com prompts longos
- Location: C:\Users\monte\Desktop\Projetos\JumboIA\tests\specs\chat.spec.ts:101:7
...
Call log:
  - waiting for getByRole('button', { name: /enviar/i })
    ...
    at C:\Users\monte\Desktop\Projetos\JumboIA\tests\specs\chat.spec.ts:107:22
```
...
- main:
  ...
  - textbox "Digite sua pergunta aqui...": Explique detalhadamente o processo de fotossíntese em plantas, incluindo todas as etapas bioquímicas, as moléculas envolvidas, a importância para o ciclo do carbono e o impacto ambiental.
  - text: 187/5000
  - button "JumboIA"
